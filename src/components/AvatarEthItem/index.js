    ...
    <Creator>
      <CreatorItem>
        ...
        <CreaterText>
          ...
          <SpanText>
            at 3/24/2021, 2:20 AM
            <a
              href="https://etherscan.io/tx/0xa80f45bc685583dcfd4f9347fcf34125daff9c77c8073736895791ffe6508ecc"
              target="_blank"
              title="View transaction on etherscan"
              class="sc-dlnjPT sc-hKFyIo sc-iemXMA sc-dIvqjp cuIYFB hEVogm dSQeHT dUMMkC"
            >
              <svg
                viewBox="0 0 12 12"
                fill="none"
              ...
              >
                <path
                  d="M3.69233 0.92308V0.92308C2.16292 0.92308 0.923096 2.16291 0.923096 3.69231V8.07693C0.923096 9.73378 2.26624 11.0769 3.9231 11.0769H8.30771C9.83712 11.0769 11.0769 9.8371 11.0769 8.3077V8.3077"
                  stroke="currentColor"
                  stroke-width="1.5"
                  stroke-linecap="round"
                ></path>
                <path
                  d="M6.46143 0.92308H11.0768V5.53847"
                  stroke="currentColor"
                  stroke-width="1.5"
                  stroke-linecap="round"
                ></path>
                <path
                  d="M11.077 0.92308L5.53857 6.46154"
                  stroke="currentColor"
                  stroke-width="1.5"
                  stroke-linecap="round"
                ></path>
